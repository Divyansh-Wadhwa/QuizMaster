    ...
    public ResponseEntity<?> submitQuiz(@RequestBody Map<String, Object> payload) {
        try {
            ...
            try {
                ...
                e.printStackTrace();
                return ResponseEntity.status(500).body("Failed to fetch questions: " + e.getMessage());
            }
            ...
            for (Map<String, Object> q : questions) {
                ...
                for (Map<String, Object> ans : answers) {
                    String ansQid = (String) ans.get("questionId");
            ...
            e.printStackTrace();
            return ResponseEntity.status(500).body("Error submitting quiz: " + e.getMessage());
        }
    }
